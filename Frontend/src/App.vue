<template>
  <v-app id="sandbox" :dark="dark" :light="!dark" standalone>
    ...
    :mini-variant="primaryDrawer.mini" absolute overflow enable-resize-watcher></v-navigation-drawer>
    <v-toolbar>
      ...
      <v-toolbar-title>Anitoon</v-toolbar-title>
    </v-toolbar>
    <main>
      <v-container fluid>
                ...
                <v-layout row wrap>
                  ...
                  <v-flex xs12 md6>
                    ...
                    <v-radio-group v-model="primaryDrawer.type" column>
                      <v-radio v-for="drawer in drawers" :key="drawer" primary :label="drawer" :value="drawer.toLowerCase()"></v-radio>
                    </v-radio-group>
